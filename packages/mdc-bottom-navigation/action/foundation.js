...
export default class MDCBottomNavigationActionFoundation extends MDCFoundation {
  ...
  constructor(adapter = {}) {
    super(Object.assign(MDCBottomNavigationActionFoundation.defaultAdapter, adapter));
